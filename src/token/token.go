...
func (_Token *TokenCaller) MINTCAPDENOMINATOR(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "MINT_CAP_DENOMINATOR")
...
//
// Solidity: function MINT_CAP_DENOMINATOR() view returns(uint256)
func (_Token *TokenSession) MINTCAPDENOMINATOR() (*big.Int, error) {
	return _Token.Contract.MINTCAPDENOMINATOR(&_Token.CallOpts)
}

// MINTCAPDENOMINATOR is a free data retrieval call binding the contract method 0x89110e5d.
//
// Solidity: function MINT_CAP_DENOMINATOR() view returns(uint256)
func (_Token *TokenCallerSession) MINTCAPDENOMINATOR() (*big.Int, error) {
	return _Token.Contract.MINTCAPDENOMINATOR(&_Token.CallOpts)
}
...
func (_Token *TokenCaller) MINTCAPNUMERATOR(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "MINT_CAP_NUMERATOR")
...
//
// Solidity: function MINT_CAP_NUMERATOR() view returns(uint256)
func (_Token *TokenSession) MINTCAPNUMERATOR() (*big.Int, error) {
	return _Token.Contract.MINTCAPNUMERATOR(&_Token.CallOpts)
}

// MINTCAPNUMERATOR is a free data retrieval call binding the contract method 0xe6be4876.
//
// Solidity: function MINT_CAP_NUMERATOR() view returns(uint256)
func (_Token *TokenCallerSession) MINTCAPNUMERATOR() (*big.Int, error) {
	return _Token.Contract.MINTCAPNUMERATOR(&_Token.CallOpts)
}
...
func (_Token *TokenCaller) MINMINTINTERVAL(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "MIN_MINT_INTERVAL")
...
//
// Solidity: function MIN_MINT_INTERVAL() view returns(uint256)
func (_Token *TokenSession) MINMINTINTERVAL() (*big.Int, error) {
	return _Token.Contract.MINMINTINTERVAL(&_Token.CallOpts)
}

// MINMINTINTERVAL is a free data retrieval call binding the contract method 0xa9f8ad04.
//
// Solidity: function MIN_MINT_INTERVAL() view returns(uint256)
func (_Token *TokenCallerSession) MINMINTINTERVAL() (*big.Int, error) {
	return _Token.Contract.MINMINTINTERVAL(&_Token.CallOpts)
}
...
func (_Token *TokenCaller) L1Address(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "l1Address")
...
//
// Solidity: function l1Address() view returns(address)
func (_Token *TokenSession) L1Address() (common.Address, error) {
	return _Token.Contract.L1Address(&_Token.CallOpts)
}

// L1Address is a free data retrieval call binding the contract method 0xc2eeeebd.
//
// Solidity: function l1Address() view returns(address)
func (_Token *TokenCallerSession) L1Address() (common.Address, error) {
	return _Token.Contract.L1Address(&_Token.CallOpts)
}
...
func (_Token *TokenCaller) NextMint(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "nextMint")
...
//
// Solidity: function nextMint() view returns(uint256)
func (_Token *TokenSession) NextMint() (*big.Int, error) {
	return _Token.Contract.NextMint(&_Token.CallOpts)
}

// NextMint is a free data retrieval call binding the contract method 0xcf665443.
//
// Solidity: function nextMint() view returns(uint256)
func (_Token *TokenCallerSession) NextMint() (*big.Int, error) {
	return _Token.Contract.NextMint(&_Token.CallOpts)
}
...
func (_Token *TokenTransactor) Initialize(opts *bind.TransactOpts, _l1TokenAddress common.Address, _initialSupply *big.Int, _owner common.Address) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "initialize", _l1TokenAddress, _initialSupply, _owner)
}

// Initialize is a paid mutator transaction binding the contract method 0xc350a1b5.
//
// Solidity: function initialize(address _l1TokenAddress, uint256 _initialSupply, address _owner) returns()
func (_Token *TokenSession) Initialize(_l1TokenAddress common.Address, _initialSupply *big.Int, _owner common.Address) (*types.Transaction, error) {
	return _Token.Contract.Initialize(&_Token.TransactOpts, _l1TokenAddress, _initialSupply, _owner)
}

// Initialize is a paid mutator transaction binding the contract method 0xc350a1b5.
//
// Solidity: function initialize(address _l1TokenAddress, uint256 _initialSupply, address _owner) returns()
func (_Token *TokenTransactorSession) Initialize(_l1TokenAddress common.Address, _initialSupply *big.Int, _owner common.Address) (*types.Transaction, error) {
	return _Token.Contract.Initialize(&_Token.TransactOpts, _l1TokenAddress, _initialSupply, _owner)
}
